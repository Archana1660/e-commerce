            ...
            <div className='relative flex flex-col m-6 space-y-4 bg-white shadow-2xl rounded-lg md:flex-row md:space-y-0 '>
                <div className='p-10 flex flex-col space-y-5 md:p-20'>
                    ...
                    <div className='flex flex-col items-center space-y-5 md:flex-row md:space-y-0 justify-between md:px-5'>
                        <Link className='flex items-center group'><img src={facebookLogo} alt="facebook" className='w-10 h-10 mr-2  group-hover:scale-105 duration-200' /> Facebook</Link>
                        <Link className='flex items-center group'><img src={gmailLogo} alt="facebook" className='max-w-auto h-10  group-hover:scale-105 duration-200' /> Google</Link>
                    </div>
                </div>
